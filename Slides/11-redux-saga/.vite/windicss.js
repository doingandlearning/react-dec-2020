...
// node_modules/windicss/lib/index.mjs
...
var Console = function() {
  ...
  Console2.time = function(label) {
    console.time(label);
  };
  Console2.timeEnd = function(label) {
...
function dashToCamel(str) {
  if (!/-/.test(str))
    return str;
  return str.toLowerCase().replace(/-(.)/g, function(_, group) {
...
function getNestedValue(obj, key) {
  ...
  while (index < key.length) {
    ...
    if (!square && !dot || (square === null || square === void 0 ? void 0 : square.index) === void 0 && (dot === null || dot === void 0 ? void 0 : dot.index) === void 0)
      return topValue;
    if (typeof topValue !== "object")
      return;
    if (dot && dot.index !== void 0 && ((square === null || square === void 0 ? void 0 : square.index) === void 0 || dot.index < square.index)) {
      var arg = dot[0].slice(1);
      topValue = topValue[arg];
      index += dot.index + dot[0].length;
    } else if (square && square.index !== void 0) {
...
function searchFrom(text2, target, startIndex, endIndex) {
  if (startIndex === void 0) {
    startIndex = 0;
  }
  var subText = text2.substring(startIndex, endIndex);
...
function flatColors(colors2, head) {
  var flatten = {};
  for (var _i = 0, _a = Object.entries(colors2); _i < _a.length; _i++) {
...
function testRegexr(text2, expressions) {
...
function searchPropEnd(text2, startIndex) {
  if (startIndex === void 0) {
    startIndex = 0;
  }
...
function searchNotEscape(text2, chars) {
  if (chars === void 0) {
    chars = ["{"];
  }
  ...
  while (i < text2.length) {
    if (chars.includes(text2.charAt(i)) && text2.charAt(i - 1) !== "\\") {
      return i;
    }
    i++;
  }
...
function guessClassName(selector) {
  ...
  if (selector.indexOf(",") >= 0)
    return splitSelectors(selector).map(function(i) {
      return guessClassName(i);
    });
...
var Property = function() {
  ...
  Property2.prototype.updateMeta = function(type, group, order2, offset, corePlugin) {
    if (offset === void 0) {
      offset = 0;
    }
...
var InlineAtRule = function(_super) {
...
var Style = function() {
  ...
  Style2.prototype.updateMeta = function(type, group, order2, offset, corePlugin, respectSelector) {
    if (offset === void 0) {
      offset = 0;
    }
    if (corePlugin === void 0) {
...
function negative(scale2) {
  return Object.keys(scale2).filter(function(key) {
    return scale2[key] !== "0";
  }).reduce(function(negativeScale, key) {
    var _a;
    return __assign(__assign({}, negativeScale), (_a = {}, _a["-".concat(key)] = negateValue(scale2[key]), _a));
  }, {});
}
function breakpoints(screens) {
  ...
  }).reduce(function(breakpoints2, key) {
    var _a;
    return __assign(__assign({}, breakpoints2), (_a = {}, _a["screen-".concat(key)] = screens[key], _a));
  }, {});
}
function generateFontSize(font2) {
  if (typeof font2 === "string")
    return [new Property("font-size", font2)];
  var properties = [];
  if (font2[0])
    properties.push(new Property("font-size", font2[0]));
  if (typeof font2[1] === "string") {
    properties.push(new Property("line-height", font2[1]));
  } else if (font2[1]) {
    if (font2[1].lineHeight)
      properties.push(new Property("line-height", font2[1].lineHeight));
    if (font2[1].letterSpacing)
      properties.push(new Property("letter-spacing", font2[1].letterSpacing));
  }
  return properties;
}
function expandDirection(value, divide2) {
  if (divide2 === void 0) {
    divide2 = false;
  }
  var map = {
    ...
    y: ["top", "bottom"],
    x: ["left", "right"],
    t: divide2 ? ["top-left", "top-right"] : ["top"],
    r: divide2 ? ["top-right", "bottom-right"] : ["right"],
    b: divide2 ? ["bottom-right", "bottom-left"] : ["bottom"],
    l: divide2 ? ["top-left", "bottom-left"] : ["left"],
    tl: ["top-left"],
    tr: ["top-right"],
    br: ["bottom-right"],
    bl: ["bottom-left"]
...
function toRGBA(color) {
  ...
  if (/^hsla?/.test(color)) {
    ...
    if (!colorTuple)
      return;
    return __spreadArray(__spreadArray([], hsl2rgb(colorTuple[0], colorTuple[1], colorTuple[2]), true), [colorTuple[3]], false);
    ...
    if (!colorTuple)
      return;
    return __spreadArray(__spreadArray([], hwb2rgb(colorTuple[0], colorTuple[1], colorTuple[2]), true), [colorTuple[3]], false);
  }
...
function toColor(colorStr) {
  ...
  var opacity2 = rgba ? rgba[3].toString() : "1";
  return {
    color,
    opacity: opacity2
  };
...
function generateScreens(screens) {
  var variants = {};
  var breakpoints2 = Object.entries(screens).sort(function(_a, _b) {
    var sizeA = _a[1];
    var sizeB = _b[1];
    return sortWeight(sizeA) - sortWeight(sizeB);
  });
  breakpoints2.forEach(function(_a, index) {
    var name = _a[0], size2 = _a[1];
    if (isString(size2)) {
      var _b = breakpoints2[index + 1] || [], nextSize = _b[1];
      variants[name] = styleForBreakpoint({ min: size2 });
      variants["<".concat(name)] = styleForBreakpoint({ max: increaseWithUnit(size2, -0.1) });
      variants["@".concat(name)] = styleForBreakpoint(nextSize ? { min: size2, max: increaseWithUnit(nextSize, -0.1) } : { min: size2 });
      variants["-".concat(name)] = styleForBreakpoint({ max: size2 });
      variants["+".concat(name)] = styleForBreakpoint(nextSize ? { min: size2, max: nextSize } : { min: size2 });
    } else {
      variants[name] = styleForBreakpoint(size2);
    }
  });
  return variants;
}
function styleForBreakpoint(rule) {
  ...
  return function() {
    return new Style().atRule("@media ".concat(mediaConditions));
  };
}
...
function generateThemes(darkMode) {
  ...
  return {
    "@dark": function() {
      return new Style().atRule("@media (prefers-color-scheme: dark)");
    },
    "@light": function() {
      return new Style().atRule("@media (prefers-color-scheme: light)");
    },
    ".dark": function() {
      return new Style().parent(".dark");
    },
    ".light": function() {
      return new Style().parent(".light");
    },
    dark: function() {
      return darkMode === "media" ? new Style().atRule("@media (prefers-color-scheme: dark)") : new Style().parent(".dark");
    },
    light: function() {
      return darkMode === "media" ? new Style().atRule("@media (prefers-color-scheme: light)") : new Style().parent(".light");
    }
  };
}
function generateStates(variantOrder2) {
  var states = {
    hover: function() {
      return new Style().pseudoClass("hover");
    },
    focus: function() {
      return new Style().pseudoClass("focus");
    },
    active: function() {
      return new Style().pseudoClass("active");
    },
    visited: function() {
      return new Style().pseudoClass("visited");
    },
    link: function() {
      return new Style().pseudoClass("link");
    },
    target: function() {
      return new Style().pseudoClass("target");
    },
    "focus-visible": function() {
      return new Style().pseudoClass("focus-visible");
    },
    "focus-within": function() {
      return new Style().pseudoClass("focus-within");
    },
    checked: function() {
      return new Style().pseudoClass("checked");
    },
    "not-checked": function() {
      return new Style().pseudoClass("not(:checked)");
    },
    default: function() {
      return new Style().pseudoClass("default");
    },
    disabled: function() {
      return new Style().pseudoClass("disabled");
    },
    enabled: function() {
      return new Style().pseudoClass("enabled");
    },
    indeterminate: function() {
      return new Style().pseudoClass("indeterminate");
    },
    invalid: function() {
      return new Style().pseudoClass("invalid");
    },
    valid: function() {
      return new Style().pseudoClass("valid");
    },
    optional: function() {
      return new Style().pseudoClass("optional");
    },
    required: function() {
      return new Style().pseudoClass("required");
    },
    "placeholder-shown": function() {
      return new Style().pseudoClass("placeholder-shown");
    },
    "read-only": function() {
      return new Style().pseudoClass("read-only");
    },
    "read-write": function() {
      return new Style().pseudoClass("read-write");
    },
    "not-disabled": function() {
      return new Style().pseudoClass("not(:disabled)");
    },
    "first-of-type": function() {
      return new Style().pseudoClass("first-of-type");
    },
    "not-first-of-type": function() {
      return new Style().pseudoClass("not(:first-of-type)");
    },
    "last-of-type": function() {
      return new Style().pseudoClass("last-of-type");
    },
    "not-last-of-type": function() {
      return new Style().pseudoClass("not(:last-of-type)");
    },
    first: function() {
      return new Style().pseudoClass("first-child");
    },
    last: function() {
      return new Style().pseudoClass("last-child");
    },
    "not-first": function() {
      return new Style().pseudoClass("not(:first-child)");
    },
    "not-last": function() {
      return new Style().pseudoClass("not(:last-child)");
    },
    "only-child": function() {
      return new Style().pseudoClass("only-child");
    },
    "not-only-child": function() {
      return new Style().pseudoClass("not(:only-child)");
    },
    "only-of-type": function() {
      return new Style().pseudoClass("only-of-type");
    },
    "not-only-of-type": function() {
      return new Style().pseudoClass("not(:only-of-type)");
    },
    even: function() {
      return new Style().pseudoClass("nth-child(even)");
    },
    odd: function() {
      return new Style().pseudoClass("nth-child(odd)");
    },
    "even-of-type": function() {
      return new Style().pseudoClass("nth-of-type(even)");
    },
    "odd-of-type": function() {
      return new Style().pseudoClass("nth-of-type(odd)");
    },
    root: function() {
      return new Style().pseudoClass("root");
    },
    empty: function() {
      return new Style().pseudoClass("empty");
    },
    before: function() {
      return new Style().pseudoElement("before");
    },
    after: function() {
      return new Style().pseudoElement("after");
    },
    "first-letter": function() {
      return new Style().pseudoElement("first-letter");
    },
    "first-line": function() {
      return new Style().pseudoElement("first-line");
    },
    "file-selector-button": function() {
      return new Style().pseudoElement("file-selector-button");
    },
    selection: function() {
      return new Style().pseudoElement("selection");
    },
    svg: function() {
      return new Style().child("svg");
    },
    all: function() {
      return new Style().child("*");
    },
    children: function() {
      return new Style().child("> *");
    },
    ...
    ltr: function() {
      return new Style().wrapSelector(function(selector) {
        return "[dir='ltr'] ".concat(selector, ", [dir='ltr']").concat(selector);
      });
    },
    rtl: function() {
      return new Style().wrapSelector(function(selector) {
        return "[dir='rtl'] ".concat(selector, ", [dir='rtl']").concat(selector);
      });
    },
    "group-hover": function() {
      return new Style().parent(".group:hover");
    },
    "group-focus": function() {
      return new Style().parent(".group:focus");
    },
    "group-active": function() {
      return new Style().parent(".group:active");
    },
    "group-visited": function() {
      return new Style().parent(".group:visited");
    },
  ...
  var orderedStates = {};
  variantOrder2.forEach(function(v) {
    if (v in states) {
...
var preflights = [
  {
    ...
    selector: ":root",
    properties: {
      "-moz-tab-size": function(theme) {
        return theme("tabSize.DEFAULT", "4");
      },
      "-o-tab-size": function(theme) {
        return theme("tabSize.DEFAULT", "4");
      },
      "tab-size": function(theme) {
        return theme("tabSize.DEFAULT", "4");
      }
    }
  },
  ...
  },
  {
    ...
    selector: "html",
    properties: {
      "font-family": function(theme) {
        return theme("fontFamily.sans", 'ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"');
      },
      "line-height": "1.5"
    }
  },
  ...
  },
  {
    ...
    properties: {
      ...
      "border-width": "0",
      "border-style": "solid",
      "border-color": function(theme) {
        return theme("borderColor.DEFAULT", "currentColor");
      }
    }
  },
  {
  ...
  },
  {
    ...
    properties: {
      ...
      "color": function(theme) {
        return theme("colors.gray.400", "#a1a1aa");
      }
    }
  },
  {
  ...
  },
  {
    ...
    properties: {
      "font-family": function(theme) {
        return theme("fontFamily.mono", 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace');
      }
    }
  },
  {
  ...
  },
  {
    ...
    properties: {
      ...
      "--tw-ring-offset-width": function(theme) {
        return theme("ringOffsetWidth.DEFAULT", "0px");
      },
      "--tw-ring-offset-color": function(theme) {
        return theme("ringOffsetColor.DEFAULT", "#fff");
      },
      "--tw-ring-color": function(theme) {
        var _a;
        return "rgba(".concat((_a = hex2RGB(theme("ringColor.DEFAULT", "#93C5FD"))) === null || _a === void 0 ? void 0 : _a.join(", "), ", ").concat(theme("ringOpacity.DEFAULT", "0.5"), ")");
      },
...
function isNumberLead(i) {
  return /^\d/.test(i) ? i : void 0;
}
function notNumberLead(i) {
  return /^\d/.test(i) ? void 0 : i;
}
function container(utility, _a) {
  ...
  if (utility.raw === "container") {
    ...
    output.forEach(function(style) {
      return style.updateMeta("utilities", "container", pluginOrder.container, 0, true);
    });
    return output;
  }
}
function objectPosition(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("objectPosition")).createProperty(["-o-object-position", "object-position"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "objectPosition", pluginOrder.objectPosition, 0, true);
}
function inset(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("inset")).handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleNegative().handleVariable().callback(function(value) {
...
function zIndex(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("zIndex")).handleNumber(0, 99999, "int").handleNegative().handleVariable().createProperty("z-index")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "zIndex", pluginOrder.zIndex, 0, true);
}
...
function order(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("order")).handleNumber(1, 9999, "int").handleNegative().handleVariable().createStyle(utility.class, function(value) {
    return [
...
function gridTemplate(utility, _a) {
  var _b, _c;
  var theme = _a.theme;
  var type = utility.raw.match(/^grid-rows-/) ? "rows" : utility.raw.match(/^grid-cols-/) ? "columns" : void 0;
  if (!type)
    return;
  var group = type === "rows" ? "gridTemplateRows" : "gridTemplateColumns";
  return ((_b = utility.handler.handleStatic(theme(group)).handleSquareBrackets(function(i) {
    return i.replace(/\(.*?\)|,/g, function(r) {
      return r === "," ? " " : r;
    });
  }).createProperty("grid-template-".concat(type), function(value) {
    return value === "none" ? "none" : value;
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", group, pluginOrder[group], 1, true)) || ((_c = utility.handler.handleNumber(1, void 0, "int").handleVariable().createProperty("grid-template-".concat(type), function(value) {
    return "repeat(".concat(value, ", minmax(0, 1fr))");
  })) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", group, pluginOrder[group], 2, true));
}
function gridColumn(utility, _a) {
  ...
  if (utility.raw.startsWith("col-span")) {
    return (_b = utility.handler.handleNumber(1, void 0, "int").handleVariable().createProperty(["-ms-grid-column-span", "grid-column"], function(value) {
      return "span ".concat(value, " / span ").concat(value);
    })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "gridColumn", pluginOrder.gridColumn, 1, true);
  }
  if (utility.raw.startsWith("col-end")) {
    return (_c = utility.handler.handleStatic(theme("gridColumnEnd")).handleSquareBrackets().handleNumber(1, void 0, "int").handleVariable().createProperty("grid-column-end")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "gridColumnEnd", pluginOrder.gridColumnEnd, 1, true);
  }
  if (utility.raw.startsWith("col-start")) {
    return (_d = utility.handler.handleStatic(theme("gridColumnStart")).handleSquareBrackets().handleNumber(1, void 0, "int").handleVariable().createProperty("grid-column-start")) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "gridColumnStart", pluginOrder.gridColumnStart, 1, true);
  }
  return (_e = utility.handler.handleSquareBrackets().createProperty(["-ms-grid-column-span", "grid-column"], function(value) {
    return "span ".concat(value, " / span ").concat(value);
  })) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "gridColumn", pluginOrder.gridColumn, 1, true);
}
function gridRow(utility, _a) {
  ...
  if (utility.raw.startsWith("row-span")) {
    return (_b = utility.handler.handleNumber(1, void 0, "int").handleVariable().createProperty(["-ms-grid-row-span", "grid-row"], function(value) {
      return "span ".concat(value, " / span ").concat(value);
    })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "gridRow", pluginOrder.gridRow, 2, true);
  }
  if (utility.raw.startsWith("row-end")) {
    return (_c = utility.handler.handleStatic(theme("gridRowEnd")).handleSquareBrackets().handleNumber(1, void 0, "int").handleVariable().createProperty("grid-row-end")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "gridRowEnd", pluginOrder.gridRowEnd, 1, true);
  }
  if (utility.raw.startsWith("row-start")) {
    return (_d = utility.handler.handleStatic(theme("gridRowStart")).handleSquareBrackets().handleNumber(1, void 0, "int").handleVariable().createProperty("grid-row-start")) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "gridRowStart", pluginOrder.gridRowStart, 1, true);
  }
  return (_e = utility.handler.handleSquareBrackets().createProperty(["-ms-grid-row-span", "grid-row"], function(value) {
    return "span ".concat(value, " / span ").concat(value);
  })) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "gridRow", pluginOrder.gridRow, 2, true);
}
function gridAuto(utility, _a) {
  var theme = _a.theme;
  var type = utility.raw.startsWith("auto-cols") ? "columns" : utility.raw.startsWith("auto-rows") ? "rows" : void 0;
  if (!type)
    return;
  ...
  if (value) {
    ...
    return new Style(utility.class, prefixer.map(function(i) {
      return new Property("grid-auto-".concat(type), i);
    })).updateMeta("utilities", group, pluginOrder[group], 2, true);
  }
}
function gap(utility, _a) {
  var theme = _a.theme, config = _a.config;
  return utility.handler.handleStatic(theme("gap")).handleSquareBrackets().handleSpacing().handleSize().handleVariable().callback(function(value) {
...
function padding(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("padding")).handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleVariable().callback(function(value) {
    ...
    if (directions) {
      ...
      return new Property(directions.map(function(i) {
        return "padding-".concat(i);
      }), value).updateMeta("utilities", "padding", pluginOrder.padding, -directions.length, true);
    }
  });
}
function margin(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("margin")).handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleNegative().handleVariable().callback(function(value) {
    var directions = expandDirection(utility.identifier.substring(1), false);
    if (directions) {
      if (directions[0] === "*")
        return new Property("margin", value).updateMeta("utilities", "margin", pluginOrder.margin, -4, true);
      return new Property(directions.map(function(i) {
        return "margin-".concat(i);
      }), value).updateMeta("utilities", "margin", pluginOrder.margin, -directions.length, true);
    }
  });
}
function space(utility, _a) {
  ...
  return utility.handler.handleStatic(theme("space")).handleSquareBrackets().handleSpacing().handleSize().handleNegative().handleVariable().callback(function(value) {
...
function size(utility, _a) {
  ...
  return (_b = utility.handler.handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleNxl(function(number) {
    return "".concat((number - 3) * 8 + 48, "rem");
  }).handleVariable().createProperty(name)) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", name, pluginOrder[name], 4, true);
}
function minMaxSize(utility, _a) {
  ...
  return (_b = utility.handler.handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleNxl(function(number) {
    return "".concat((number - 3) * 8 + 48, "rem");
  }).handleVariable().createProperty(prop)) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", group, pluginOrder[group], 4, true);
}
function text(utility, _a) {
  var _b, _c, _d, _e, _f, _g;
  var theme = _a.theme;
  if (utility.raw.startsWith("text-opacity")) {
    return (_b = utility.handler.handleStatic(theme("textOpacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-text-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "textOpacity", pluginOrder.textOpacity, 1, true);
  }
  if (utility.raw.startsWith("text-shadow")) {
    return (_c = utility.raw === "text-shadow" ? new Property("text-shadow", theme("textShadow.DEFAULT", "0px 0px 1px rgb(0 0 0 / 20%), 0px 0px 1px rgb(1 0 5 / 10%)")) : utility.handler.handleStatic(theme("textShadow")).createProperty("text-shadow")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "textShadow", pluginOrder.textShadow, 1, true);
  }
  if (utility.raw.startsWith("text-stroke")) {
    ...
    if (utility.raw.startsWith("text-stroke-opacity")) {
      return (_d = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
        return (number / 100).toString();
      }).handleVariable().createProperty("--tw-ring-offset-opacity")) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "textStrokeColor", pluginOrder.textStrokeColor, 3, true);
    }
    return ((_e = utility.clone("textStroke" + utility.raw.slice(11)).handler.handleColor(theme("textStrokeColor")).handleOpacity(theme("opacity")).handleVariable().createColorStyle(utility.class, "-webkit-text-stroke-color", "--tw-text-stroke-opacity")) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "textStrokeColor", pluginOrder.textStrokeColor, 2, true)) || ((_f = utility.handler.handleStatic(theme("textStrokeWidth")).handleNumber(0, void 0, "int", function(number) {
      return "".concat(number, "px");
    }).handleSize().createProperty("-webkit-text-stroke-width")) === null || _f === void 0 ? void 0 : _f.updateMeta("utilities", "textStrokeWidth", pluginOrder.textStrokeWidth, 1, true));
  }
  var textColor = (_g = utility.handler.handleColor(theme("textColor")).handleOpacity(theme("textOpacity")).handleSquareBrackets(notNumberLead).handleVariable().createColorStyle(utility.class, "color", "--tw-text-opacity")) === null || _g === void 0 ? void 0 : _g.updateMeta("utilities", "textColor", pluginOrder.textColor, 0, true);
  if (textColor)
    return textColor;
  ...
  var value = utility.handler.handleSquareBrackets(isNumberLead).handleNxl(function(number) {
...
function font(utility, _a) {
  ...
  return ((_b = utility.handler.handleStatic(map).createProperty("font-family")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "fontFamily", pluginOrder.fontFamily, 1, true)) || ((_c = utility.handler.handleStatic(theme("fontWeight")).handleNumber(0, 900, "int").handleVariable().createProperty("font-weight")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "fontWeight", pluginOrder.fontWeight, 1, true));
}
function letterSpacing(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("letterSpacing")).handleSquareBrackets().handleSize().handleNegative().handleVariable().createProperty("letter-spacing")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "letterSpacing", pluginOrder.letterSpacing, 1, true);
}
function textDecoration(utility, _a) {
  var _b, _c, _d, _e;
  var theme = _a.theme;
  if (utility.raw.startsWith("underline-opacity")) {
    return (_b = utility.handler.handleStatic(theme("textDecorationOpacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-line-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "textDecorationOpacity", pluginOrder.textDecorationOpacity, 1, true);
  }
  if (utility.raw.startsWith("underline-offset")) {
    return (_c = utility.handler.handleStatic(theme("textDecorationOffset")).handleNumber(0, void 0, "int", function(number) {
      return "".concat(number, "px");
    }).handleSize().createProperty("text-underline-offset")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "textDecorationOffset", pluginOrder.textDecorationOffset, 1, true);
  }
  return ((_d = utility.handler.handleColor(theme("textDecorationColor")).handleOpacity(theme("opacity")).handleVariable().createColorStyle(utility.class, ["-webkit-text-decoration-color", "text-decoration-color"], "--tw-line-opacity")) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "textDecorationColor", pluginOrder.textDecorationColor, 0, true)) || ((_e = utility.handler.handleStatic(theme("textDecorationLength")).handleNumber(0, void 0, "int", function(number) {
    return "".concat(number, "px");
  }).handleSize().createProperty("text-decoration-thickness")) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "textDecorationLength", pluginOrder.textDecorationLength, 1, true));
}
function lineHeight(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("lineHeight")).handleNumber(0, void 0, "int", function(number) {
    return "".concat(number * 0.25, "rem");
  }).handleSquareBrackets().handleSize().handleVariable().createProperty("line-height")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "lineHeight", pluginOrder.lineHeight, 1, true);
}
function listStyleType(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("listStyleType")).createProperty("list-style-type")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "listStyleType", pluginOrder.listStyleType, 1, true);
}
function placeholder(utility, _a) {
  var theme = _a.theme, config = _a.config;
  if (utility.raw.startsWith("placeholder-opacity")) {
    return utility.handler.handleStatic(theme("placeholderOpacity")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().callback(function(value) {
      return generatePlaceholder(utility.class, new Property("--tw-placeholder-opacity", value), config("prefixer")).map(function(style) {
        return style.updateMeta("utilities", "placeholderOpacity", pluginOrder.placeholderOpacity, 1, true);
      });
    });
  }
  var color = utility.handler.handleColor(theme("placeholderColor")).handleOpacity(theme("placeholderOpacity")).handleSquareBrackets().handleVariable().createColorStyle(utility.class, "color", "--tw-placeholder-opacity");
  if (color)
    return generatePlaceholder(color.selector || "", color.property, config("prefixer")).map(function(i) {
      return i.updateMeta("utilities", "placeholderColor", pluginOrder.placeholderColor, 2, true);
    });
}
function caret(utility, _a) {
  ...
  if (utility.raw.startsWith("caret-opacity")) {
    return (_b = utility.handler.handleStatic(theme("caretOpacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-caret-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "caretOpacity", pluginOrder.caretOpacity, 1, true);
  }
  return (_c = utility.handler.handleColor(theme("caretColor")).handleOpacity(theme("caretOpacity")).handleVariable().createColorStyle(utility.class, "caret-color", "--tw-caret-opacity")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "caretColor", pluginOrder.caretColor, 0, true);
}
function tabSize(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("tabSize")).handleNumber(0, void 0, "int").handleSize().createProperty(["-moz-tab-size", "-o-tab-size", "tab-size"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "tabSize", pluginOrder.tabSize, 1, true);
}
function textIndent(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("textIndent")).handleSize().handleFraction().handleNegative().createProperty("text-indent")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "textIndent", pluginOrder.textIndent, 1, true);
}
function background(utility, _a) {
  ...
  if (Object.keys(images).includes(body)) {
    ...
    if (Array.isArray(prefixer))
      return new Style(utility.class, prefixer.map(function(i) {
        return new Property("background-image", i);
      })).updateMeta("utilities", "backgroundImage", pluginOrder.backgroundImage, 2, true);
  ...
  if (utility.raw.startsWith("bg-opacity"))
    return (_b = utility.handler.handleStatic(theme("backgroundOpacity")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-bg-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "backgroundOpacity", pluginOrder.backgroundOpacity, 1, true);
  return (_c = utility.handler.handleColor(theme("backgroundColor")).handleOpacity(theme("backgroundOpacity")).handleSquareBrackets(notNumberLead).handleVariable().createColorStyle(utility.class, "background-color", "--tw-bg-opacity")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "backgroundColor", pluginOrder.backgroundColor, 0, true);
}
function gradientColorFrom(utility, _a) {
  var _b;
  var theme = _a.theme;
  if (utility.raw.startsWith("from-opacity")) {
    return (_b = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-from-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "gradientColorStops", pluginOrder.gradientColorStops, 2, true);
  }
...
function gradientColorVia(utility, _a) {
  ...
  if (utility.raw.startsWith("via-opacity")) {
    return (_b = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-via-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "gradientColorStops", pluginOrder.gradientColorStops, 4, true);
  }
  var handler = utility.handler.handleColor(theme("gradientColorStops")).handleOpacity(theme("opacity")).handleVariable().handleSquareBrackets();
  if (handler.color || handler.value) {
...
function gradientColorTo(utility, _a) {
  ...
  if (utility.raw.startsWith("to-opacity")) {
    return (_b = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-to-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "gradientColorStops", pluginOrder.gradientColorStops, 6, true);
  }
  var handler = utility.handler.handleColor(theme("gradientColorStops")).handleOpacity(theme("opacity")).handleVariable().handleSquareBrackets();
  if (handler.color || handler.value) {
...
function borderRadius(utility, _a) {
  ...
  if (!directions)
    return;
  return (_c = utility.handler.handleStatic(theme("borderRadius")).handleSquareBrackets().handleFraction().handleNxl(function(number) {
    return "".concat(number * 0.5, "rem");
  }).handleSize().handleVariable().createProperty(directions[0] === "*" ? "border-radius" : directions.map(function(i) {
    return "border-".concat(i, "-radius");
  }))) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "borderRadius", pluginOrder.borderRadius, -(directions[0] === "*" ? 3 : directions.length), true);
}
function border(utility, _a) {
  var _b, _c, _d, _e, _f, _g;
  var theme = _a.theme;
  if (utility.raw.startsWith("border-opacity")) {
    return (_b = utility.handler.handleStatic(theme("borderOpacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-border-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "borderOpacity", pluginOrder.borderOpacity, 1, true);
  }
  var borderColor = (_c = utility.handler.handleColor(theme("borderColor")).handleOpacity(theme("borderOpacity")).handleSquareBrackets(notNumberLead).handleVariable(function(variable) {
    return utility.raw.startsWith("border-$") ? "var(--".concat(variable, ")") : void 0;
  ...
  var raw = ["border", "border-t", "border-r", "border-b", "border-l"].includes(utility.raw) ? "".concat(utility.raw, "-").concat((_e = borders.DEFAULT) !== null && _e !== void 0 ? _e : "1px") : utility.raw;
  var borderSide = utility.clone(raw.slice(7)).handler.handleColor(theme("borderColor")).handleOpacity(theme("borderOpacity"));
  ...
  utility = utility.clone(raw);
  return (_g = utility.handler.handleStatic(borders).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
    return /^border(-[tlbr])?$/.test(utility.key) ? "".concat(number, "px") : void 0;
  }).handleSize().handleVariable().createProperty(directions[0] === "*" ? "border-width" : directions.map(function(i) {
    return "border-".concat(i, "-width");
  }))) === null || _g === void 0 ? void 0 : _g.updateMeta("utilities", "borderWidth", pluginOrder.borderWidth, directions[0] === "*" ? 1 : directions.length + 1, true);
}
function divide(utility, _a) {
  ...
  if (utility.raw.startsWith("divide-opacity"))
    return (_b = utility.handler.handleStatic(theme("divideOpacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-divide-opacity")) === null || _b === void 0 ? void 0 : _b.toStyle(utility.class).child("> :not([hidden]) ~ :not([hidden])").updateMeta("utilities", "divideOpacity", pluginOrder.divideOpacity, 1, true);
  var divideColor = (_c = utility.handler.handleColor(theme("divideColor")).handleOpacity(theme("divideOpacity")).handleVariable(function(variable) {
    return utility.raw.startsWith("divide-$") ? "var(--".concat(variable, ")") : void 0;
  ...
  return utility.handler.handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
    return "".concat(number, "px");
  }).handleSize().handleVariable().callback(function(value) {
...
function ringOffset(utility, _a) {
  ...
  if (utility.raw.startsWith("ringOffset-opacity")) {
    return (_b = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-ring-offset-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "ringOffsetColor", pluginOrder.ringOffsetColor, 2, true);
  }
  return ((_c = utility.handler.handleColor(theme("ringOffsetColor")).handleOpacity("ringOpacity").handleVariable().handleSquareBrackets().createColorStyle(utility.class.replace("ringOffset", "ring-offset"), "--tw-ring-offset-color", "--tw-ring-offset-opacity")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "ringOffsetColor", pluginOrder.ringOffsetColor, 1, true)) || ((_d = utility.handler.handleStatic(theme("ringOffsetWidth")).handleSquareBrackets(isNumberLead).handleNumber(0, void 0, "float", function(number) {
    return "".concat(number, "px");
  }).handleSize().createStyle(utility.class.replace("ringOffset", "ring-offset"), function(value2) {
    return new Property("--tw-ring-offset-width", value2);
  })) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "ringOffsetWidth", pluginOrder.ringOffsetWidth, 1, true));
}
function ring(utility, utils) {
  ...
  if (utility.raw.startsWith("ring-opacity"))
    return (_a = utility.handler.handleStatic(utils.theme("ringOpacity")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-ring-opacity")) === null || _a === void 0 ? void 0 : _a.updateMeta("utilities", "ringOpacity", pluginOrder.ringOpacity, 1, true);
  var ringColor = (_b = utility.handler.handleColor(utils.theme("ringColor")).handleOpacity(utils.theme("ringOpacity")).handleSquareBrackets(notNumberLead).handleVariable(function(variable) {
    return utility.raw.startsWith("ring-$") ? "var(--".concat(variable, ")") : void 0;
  ...
  var value = utility.raw === "ring" ? (_c = toType(utils.theme("ringWidth.DEFAULT"), "string")) !== null && _c !== void 0 ? _c : "3px" : utility.handler.handleStatic(utils.theme("ringWidth")).handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
    return "".concat(number, "px");
  }).handleSize().handleVariable().value;
  if (!value)
    return;
  return new Style(utility.class, [
...
function blur(utility, _a) {
  ...
  return (_b = utility.handler.handleBody(theme("blur")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
    return "".concat(number, "px");
  }).handleSize().createProperty("--tw-blur", function(value) {
    return "blur(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "blur", pluginOrder.blur, 1, true);
}
function brightness(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("brightness")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
    return "".concat(number / 100);
  }).createProperty("--tw-brightness", function(value) {
    return "brightness(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "brightness", pluginOrder.brightness, 1, true);
}
function contrast(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("contrast")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
    return "".concat(number / 100);
  }).createProperty("--tw-contrast", function(value) {
    return "contrast(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "contrast", pluginOrder.contrast, 1, true);
}
function dropShadow(utility, _a) {
  ...
  if (value)
    return new Property("--tw-drop-shadow", Array.isArray(value) ? value.map(function(i) {
      return "drop-shadow(".concat(i, ")");
    }).join(" ") : "drop-shadow(".concat(value, ")")).updateMeta("utilities", "dropShadow", pluginOrder.dropShadow, 1, true);
}
function grayscale(utility, _a) {
  ...
  return (_b = utility.handler.handleBody(theme("grayscale")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
    return "".concat(number / 100);
  }).createProperty("--tw-grayscale", function(value) {
    return "grayscale(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "grayscale", pluginOrder.grayscale, 1, true);
}
function hueRotate(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("hueRotate")).handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
    return "".concat(number, "deg");
  }).handleNegative().createProperty("--tw-hue-rotate", function(value) {
    return "hue-rotate(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "hueRotate", pluginOrder.hueRotate, 1, true);
}
function invert(utility, _a) {
  ...
  return (_b = utility.handler.handleBody(theme("invert")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
    return "".concat(number / 100);
  }).createProperty("--tw-invert", function(value) {
    return "invert(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "invert", pluginOrder.invert, 1, true);
}
function saturate(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("saturate")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
    return "".concat(number / 100);
  }).createProperty("--tw-saturate", function(value) {
    return "saturate(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "saturate", pluginOrder.saturate, 1, true);
}
function sepia(utility, _a) {
  ...
  return (_b = utility.handler.handleBody(theme("sepia")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
    return "".concat(number / 100);
  }).createProperty("--tw-sepia", function(value) {
    return "sepia(".concat(value, ")");
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "sepia", pluginOrder.sepia, 1, true);
}
function backdrop(utility, _a) {
  ...
  switch (utility.match(/[^-]+/)) {
    case "blur":
      if (utility.raw === "blur")
        utility.raw = "blur-DEFAULT";
      return (_b = utility.handler.handleBody(theme("backdropBlur")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
        return "".concat(number, "px");
      }).handleSize().createProperty("--tw-backdrop-blur", function(value) {
        return "blur(".concat(value, ")");
      })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "backdropBlur", pluginOrder.backdropBlur, 1, true);
    case "brightness":
      return (_c = utility.handler.handleBody(theme("backdropBrightness")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-brightness", function(value) {
        return "brightness(".concat(value, ")");
      })) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "backdropBrightness", pluginOrder.backdropBrightness, 1, true);
    case "contrast":
      return (_d = utility.handler.handleBody(theme("backdropContrast")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-contrast", function(value) {
        return "contrast(".concat(value, ")");
      })) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "backdropContrast", pluginOrder.backdropContrast, 1, true);
    case "grayscale":
      if (utility.raw === "grayscale")
        utility.raw = "grayscale-DEFAULT";
      return (_e = utility.handler.handleBody(theme("backdropGrayscale")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-grayscale", function(value) {
        return "grayscale(".concat(value, ")");
      })) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "backdropGrayscale", pluginOrder.backdropGrayscale, 1, true);
    case "hue":
      return (_f = utility.handler.handleBody(theme("backdropHueRotate")).handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
        return "".concat(number, "deg");
      }).handleNegative().createProperty("--tw-backdrop-hue-rotate", function(value) {
        return "hue-rotate(".concat(value, ")");
      })) === null || _f === void 0 ? void 0 : _f.updateMeta("utilities", "backdropHueRotate", pluginOrder.backdropHueRotate, 1, true);
    case "invert":
      if (utility.raw === "invert")
        utility.raw = "invert-DEFAULT";
      return (_g = utility.handler.handleBody(theme("backdropInvert")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-invert", function(value) {
        return "invert(".concat(value, ")");
      })) === null || _g === void 0 ? void 0 : _g.updateMeta("utilities", "backdropInvert", pluginOrder.backdropInvert, 1, true);
    case "opacity":
      return (_h = utility.handler.handleBody(theme("backdropOpacity")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-opacity", function(value) {
        return "opacity(".concat(value, ")");
      })) === null || _h === void 0 ? void 0 : _h.updateMeta("utilities", "backdropOpacity", pluginOrder.backdropOpacity, 1, true);
    case "saturate":
      return (_j = utility.handler.handleBody(theme("backdropSaturate")).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-saturate", function(value) {
        return "saturate(".concat(value, ")");
      })) === null || _j === void 0 ? void 0 : _j.updateMeta("utilities", "backdropSaturate", pluginOrder.backdropSaturate, 1, true);
    case "sepia":
      if (utility.raw === "sepia")
        utility.raw = "sepia-DEFAULT";
      return (_k = utility.handler.handleBody(theme("backdropSepia")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
        return "".concat(number / 100);
      }).createProperty("--tw-backdrop-sepia", function(value) {
        return "sepia(".concat(value, ")");
      })) === null || _k === void 0 ? void 0 : _k.updateMeta("utilities", "backdropSepia", pluginOrder.backdropSepia, 1, true);
  }
}
function boxShadow(utility, _a) {
  ...
  return (_b = utility.handler.handleColor(theme("boxShadowColor")).handleOpacity(theme("opacity")).handleSquareBrackets().handleVariable().createColorStyle(utility.class, "--tw-shadow-color", void 0, false)) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "boxShadowColor", pluginOrder.boxShadowColor, 0, true);
}
function opacity(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("opacity")).handleSquareBrackets().handleNumber(0, 100, "int", function(number) {
    return (number / 100).toString();
  }).handleVariable().createProperty("opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "opacity", pluginOrder.opacity, 0, true);
}
...
function duration(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("transitionDuration")).handleSquareBrackets().handleTime(0, void 0, "float").handleNumber(0, void 0, "int", function(number) {
    return "".concat(number, "ms");
  }).handleVariable().createProperty(["-webkit-transition-duration", "-o-transition-duration", "transition-duration"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "transitionDuration", pluginOrder.transitionDuration, 1, true);
}
function transitionTimingFunction(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleBody(theme("transitionTimingFunction")).createProperty(["-webkit-transition-timing-function", "-o-transition-timing-function", "transition-timing-function"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "transitionTimingFunction", pluginOrder.transitionTimingFunction, 1, true);
}
function delay(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("transitionDelay")).handleSquareBrackets().handleTime(0, void 0, "float").handleNumber(0, void 0, "int", function(number) {
    return "".concat(number, "ms");
  }).handleVariable().createProperty(["-webkit-transition-delay", "-o-transition-delay", "transition-delay"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "transitionDelay", pluginOrder.transitionDelay, 0, true);
}
function animation(utility, _a) {
  ...
  if (utility.raw.startsWith("animate-ease")) {
    return (_b = utility.clone(utility.raw.slice(8)).handler.handleBody(theme("animationTimingFunction")).handleSquareBrackets().createProperty(["-webkit-animation-timing-function", "animation-timing-function"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "animation", pluginOrder.animation, 20, true);
  }
  if (utility.raw.startsWith("animate-duration")) {
    return (_c = utility.clone(utility.raw.slice(8)).handler.handleStatic(theme("animationDuration")).handleSquareBrackets().handleTime(0, void 0, "float").handleNumber(0, void 0, "int", function(number) {
      return "".concat(number, "ms");
    }).handleVariable().createProperty(["-webkit-animation-duration", "animation-duration"])) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "animation", pluginOrder.animation, 21, true);
  }
  if (utility.raw.startsWith("animate-delay")) {
    return (_d = utility.clone(utility.raw.slice(8)).handler.handleStatic(theme("animationDelay")).handleSquareBrackets().handleTime(0, void 0, "float").handleNumber(0, void 0, "int", function(number) {
      return "".concat(number, "ms");
    }).handleVariable().createProperty(["-webkit-animation-delay", "animation-delay"])) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "animation", pluginOrder.animation, 22, true);
  }
  var animateIterationCount = utility.handler.handleBody(theme("animationIterationCount")).handleNumber(0, void 0, "int").handleSquareBrackets().value;
  ...
  if (Object.keys(animations).includes(body)) {
    ...
    if (typeof value === "string") {
      ...
      styles = Style.generate(utility.class, value).map(function(i) {
        return i.updateMeta("utilities", "animation", pluginOrder.animation, 2, true);
      });
    }
    if (styles) {
      return __spreadArray(__spreadArray([], styles.map(function(i) {
        return i.updateMeta("utilities", "animation", pluginOrder.animation, 2, true);
      }), true), keyframe ? Keyframes.generate(keyframe, (_f = theme("keyframes.".concat(keyframe))) !== null && _f !== void 0 ? _f : {}, void 0, config("prefixer", false)).map(function(i) {
        return i.updateMeta("utilities", "keyframes", pluginOrder.keyframes, 1, true);
      }) : [], true);
    }
  }
}
...
function scale(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("scale")).handleNumber(0, void 0, "int", function(number) {
    return (number / 100).toString();
  }).handleVariable().callback(function(value) {
...
function rotate(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("rotate")).handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
    return "".concat(number, "deg");
  }).handleNegative().handleVariable().callback(function(value) {
...
function translate(utility, _a) {
  ...
  if (centerMatch) {
    ...
    return (_b = utility.handler.handleStatic(theme("translate")).handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleNegative().handleVariable().createProperty("--tw-translate-".concat(center))) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "translate", pluginOrder.translate, utility.raw.charAt(0) === "-" ? 2 : 1, true);
  }
}
function skew(utility, _a) {
  ...
  if (centerMatch) {
    ...
    return (_b = utility.handler.handleStatic(theme("skew")).handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
      return "".concat(number, "deg");
    }).handleNegative().handleVariable().createProperty("--tw-skew-".concat(center))) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "skew", pluginOrder.skew, utility.raw.charAt(0) === "-" ? 2 : 1, true);
  }
}
function perspective(utility, _a) {
  ...
  if (utility.raw.startsWith("perspect-origin")) {
    var origin_1 = (_b = utility.clone("perspectOrigin" + utility.raw.slice(15)).handler.handleBody(theme("perspectiveOrigin")).handleSquareBrackets().createProperty(["-webkit-perspective-origin", "perspective-origin"])) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "perspectiveOrigin", pluginOrder.perspectiveOrigin, 0, true);
    if (origin_1)
      return origin_1;
  }
  return (_c = utility.handler.handleStatic(theme("perspective")).handleNumber(0, void 0, "int", function(number) {
    return "".concat(number, "px");
  }).handleSize().handleSquareBrackets().createProperty(["-webkit-perspective", "perspective"])) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "perspective", pluginOrder.perspective, 0, true);
}
...
function outline(utility, _a) {
  ...
  if (utility.raw.startsWith("outline-opacity")) {
    return (_b = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-outline-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "outline", pluginOrder.outline, 4, true);
  }
  if (utility.raw.match(/^outline-(solid|dotted)/)) {
    var newUtility = utility.clone(utility.raw.replace("outline-", ""));
    var outlineColor = newUtility.handler.handleStatic({ none: "transparent", white: "white", black: "black" }).handleColor().handleOpacity(theme("opacity")).handleVariable().createColorValue("var(--tw-outline-opacity, 1)");
    if (outlineColor)
      return new Style(utility.class, [
        new Property("outline", "2px ".concat(newUtility.identifier, " ").concat(outlineColor)),
        new Property("outline-offset", "2px")
      ]).updateMeta("utilities", "outline", pluginOrder.outline, 3, true);
  }
  var handler = utility.handler.handleColor().handleOpacity(theme("opacity")).handleSquareBrackets().handleVariable(function(variable) {
    return utility.raw.startsWith("outline-$") ? "var(--".concat(variable, ")") : void 0;
  });
  var color = handler.createColorValue();
  if (color)
    return (_c = new Style(utility.class, [
      new Property("outline", "2px ".concat(handler.value === "transparent" ? "solid" : "dotted", " ").concat(color)),
      new Property("outline-offset", "2px")
...
function fill(utility, _a) {
  ...
  if (utility.raw.startsWith("fill-opacity")) {
    return (_b = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-fill-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "fill", pluginOrder.ringOffsetColor, 2, true);
  }
  return (_c = utility.handler.handleColor(theme("fill")).handleOpacity(theme("opacity")).handleSquareBrackets().handleVariable().createColorStyle(utility.class, "fill", "--tw-fill-opacity")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "fill", pluginOrder.fill, 1, true);
}
function stroke(utility, _a) {
  ...
  if (utility.raw.startsWith("stroke-opacity")) {
    return (_d = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-stroke-opacity")) === null || _d === void 0 ? void 0 : _d.updateMeta("utilities", "stroke", pluginOrder.stroke, 2, true);
  }
  return ((_e = utility.handler.handleColor(theme("stroke")).handleOpacity(theme("opacity")).handleVariable().handleSquareBrackets().createColorStyle(utility.class, "stroke", "--tw-stroke-opacity")) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "stroke", pluginOrder.stroke, 1, true)) || (utility.raw.startsWith("stroke-$") ? (_f = utility.handler.handleVariable().createProperty("stroke-width")) === null || _f === void 0 ? void 0 : _f.updateMeta("utilities", "strokeWidth", pluginOrder.strokeWidth, 2, true) : (_g = utility.handler.handleStatic(theme("strokeWidth")).handleNumber(0, void 0, "int").createProperty("stroke-width")) === null || _g === void 0 ? void 0 : _g.updateMeta("utilities", "strokeWidth", pluginOrder.strokeWidth, 1, true));
}
function content(utility, _a) {
  ...
  if (!/^content-(?!$)/.test(utility.raw))
    return;
  return (_b = utility.handler.handleBody(theme("content")).handleSquareBrackets().handleVariable().handleString(function(string) {
...
var baseConfig = {
  ...
  theme: {
    ...
    backdropBlur: function(theme) {
      return theme("blur");
    },
    backdropBrightness: function(theme) {
      return theme("brightness");
    },
    backdropContrast: function(theme) {
      return theme("contrast");
    },
    backdropGrayscale: function(theme) {
      return theme("grayscale");
    },
    backdropHueRotate: function(theme) {
      return theme("hueRotate");
    },
    backdropInvert: function(theme) {
      return theme("invert");
    },
    backdropOpacity: function(theme) {
      return theme("opacity");
    },
    backdropSaturate: function(theme) {
      return theme("saturate");
    },
    backdropSepia: function(theme) {
      return theme("sepia");
    },
    ...
    backgroundOpacity: function(theme) {
      return theme("opacity");
    },
    backgroundPosition: {
      bottom: "bottom",
    ...
    divideColor: function(theme) {
      return theme("borderColor");
    },
    divideOpacity: function(theme) {
      return theme("borderOpacity");
    },
    divideWidth: function(theme) {
    ...
    height: function(theme, _a) {
      var _b, _c;
      var breakpoints2 = _a.breakpoints;
      return __assign(__assign(__assign({ auto: "auto" }, (_b = theme("spacing")) !== null && _b !== void 0 ? _b : {}), {
        ...
        prose: "65ch",
        screen: "100vh"
      }), breakpoints2((_c = theme("screens")) !== null && _c !== void 0 ? _c : {}));
    },
    hueRotate: {
      "-180": "-180deg",
      "-90": "-90deg",
    ...
    inset: function(theme, _a) {
      var _b;
      var negative2 = _a.negative;
      return __assign(__assign(__assign({ auto: "auto" }, (_b = theme("spacing")) !== null && _b !== void 0 ? _b : {}), negative2(theme("spacing"))), { "1/2": "50%", "1/3": "33.333333%", "2/3": "66.666667%", "1/4": "25%", "2/4": "50%", "3/4": "75%", full: "100%", "-1/2": "-50%", "-1/3": "-33.333333%", "-2/3": "-66.666667%", "-1/4": "-25%", "-2/4": "-50%", "-3/4": "-75%", "-full": "-100%" });
    },
    invert: {
      DEFAULT: "100%",
      0: "0"
    ...
    margin: function(theme, _a) {
      var _b;
      var negative2 = _a.negative;
      return __assign(__assign({ auto: "auto" }, (_b = theme("spacing")) !== null && _b !== void 0 ? _b : {}), negative2(theme("spacing")));
    },
    maxHeight: function(theme, _a) {
      var _b, _c;
      var breakpoints2 = _a.breakpoints;
      return __assign(__assign(__assign({ none: "none" }, (_b = theme("spacing")) !== null && _b !== void 0 ? _b : {}), {
        xs: "20rem",
        sm: "24rem",
        md: "28rem",
        lg: "32rem",
    ...
    placeholderColor: function(theme) {
      return theme("colors");
    },
    placeholderOpacity: function(theme) {
      return theme("opacity");
    },
    ...
    ringOffsetColor: function(theme) {
      return theme("colors");
    },
    ringOffsetWidth: {
      0: "0px",
    ...
    space: function(theme, _a) {
      var negative2 = _a.negative;
      return __assign(__assign({}, theme("spacing")), negative2(theme("spacing")));
    },
    ...
    textColor: function(theme) {
      return theme("colors");
    },
    textOpacity: function(theme) {
      return theme("opacity");
    },
    textShadow: {
    ...
    textDecorationColor: function(theme) {
      return theme("colors");
    },
    textDecorationOpacity: function(theme) {
      return theme("opacity");
    },
    ...
    translate: function(theme, _a) {
      var _b;
      var negative2 = _a.negative;
      return __assign(__assign(__assign({}, (_b = theme("spacing")) !== null && _b !== void 0 ? _b : {}), negative2(theme("spacing"))), { "1/2": "50%", "1/3": "33.333333%", "2/3": "66.666667%", "1/4": "25%", "2/4": "50%", "3/4": "75%", full: "100%", "-1/2": "-50%", "-1/3": "-33.333333%", "-2/3": "-66.666667%", "-1/4": "-25%", "-2/4": "-50%", "-3/4": "-75%", "-full": "-100%" });
    },
    ...
    var handler = {
      ...
      handleStatic: handlers.static ? function(map, callback) {
        ...
        if (map && typeof map === "object") {
          ...
          if (handler._amount in knownMap)
            handler.value = callback ? callback(handler._amount) : "".concat(knownMap[handler._amount]);
        }
        return handler;
      } : function() {
        return handler;
      ...
      handleTime: handlers.time ? function(start, end, type, callback) {
        ...
        if (isNumber(amount, start, end, type))
          handler.value = callback ? callback(unit === "s" ? +amount * 1e3 : +amount) : handler._amount;
        return handler;
      } : function() {
        return handler;
      },
      ...
      handleSquareBrackets: handlers.bracket ? function(callback) {
        ...
        if (handler._amount[0] === "[" && handler._amount[handler._amount.length - 1] === "]") {
          var value_1 = handler._amount.slice(1, -1).replace(/_/g, " ");
          if (value_1.indexOf("calc(") > -1) {
            value_1 = value_1.replace(/(-?\d*\.?\d(?!\b-.+[,)](?![^+\-/*])\D)(?:%|[a-z]+)?|\))([+\-/*])/g, "$1 $2 ");
          }
          handler.value = callback ? callback(value_1) : value_1;
        }
        return handler;
      } : function() {
        return handler;
      ...
      handleSpacing: handlers.number ? function() {
        return handler.handleNumber(0, void 0, "float", function(number) {
      ...
      handleNxl: handlers.nxl ? function(callback) {
        ...
        if (/^\d*xl$/.test(handler._amount))
          handler.value = callback ? callback(handler._amount === "xl" ? 1 : parseInt(handler._amount)) : parseInt(handler._amount).toString();
        return handler;
      } : function() {
        return handler;
      },
      handleFraction: handlers.fraction ? function(callback) {
        ...
        if (isFraction(handler._amount))
          handler.value = callback ? callback(handler._amount) : fracToPercent(handler._amount);
        return handler;
      } : function() {
        return handler;
      },
      ...
      handleColor: handlers.color ? function(map) {
        ...
        var color2;
        if (map && typeof map === "object") {
          var colors2 = flatColors(map);
          var body = handler.utility.raw.replace(/^ring-offset|outline-solid|outline-dotted/, "head").replace(/^\w+-/, "");
          var _a = splitColorGroup(body), key = _a[0], opacity2 = _a[1];
          handler.opacity = opacity2;
          if (key in colors2) {
            color2 = colors2[key];
          ...
          if (typeof color2 === "string") {
            handler.value = color2;
          } else if (typeof color2 === "function") {
            handler.color = color2;
          }
        }
        return handler;
      } : function() {
      ...
      createProperty: function(name, callback) {
        if (!handler.value)
          return;
        var value2 = callback ? callback(handler.value) : handler.value;
        return new Property(name, value2);
      },
      createStyle: function(selector, callback) {
        if (!handler.value)
          return;
        var value2 = callback ? callback(handler.value) : void 0;
        return new Style(selector, value2);
      },
      ...
      createColorStyle: function(selector, property, opacityVariable, wrapRGB) {
        ...
        if (handler.color) {
          var value_2 = handler.color({ opacityVariable, opacityValue: opacityVariable ? "var(".concat(opacityVariable, ")") : void 0 });
          if (opacityVariable) {
        ...
        var color2 = handler.value;
        if (!color2)
          return;
        if (["transparent", "currentColor", "auto", "none"].includes(color2) || color2.includes("var"))
          return new Style(selector, new Property(property, color2));
        var rgb = toColor(color2);
        if (opacityVariable) {
          return new Style(selector, [
...
var Utility = function() {
  function Utility2(raw, _h) {
    this.raw = raw;
    this._h = _h;
  }
  Utility2.prototype.match = function(expression) {
    var match = this.absolute.match(expression);
    return match ? match[0] : "";
  };
  Utility2.prototype.clone = function(raw) {
    return new Utility2(raw || this.raw, this._h);
  };
  Object.defineProperty(Utility2.prototype, "class", {
    get: function() {
      return "." + cssEscape(this.raw);
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Utility2.prototype, "isNegative", {
    get: function() {
      return this.raw[0] === "-";
    },
    enumerable: false,
  ...
  Object.defineProperty(Utility2.prototype, "absolute", {
    get: function() {
  ...
  Object.defineProperty(Utility2.prototype, "identifier", {
    get: function() {
      return this.match(/[^-]+/);
    },
    enumerable: false,
  ...
  Object.defineProperty(Utility2.prototype, "key", {
    get: function() {
      return this.match(/^\w[-\w]+(?=-)/);
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Utility2.prototype, "center", {
    get: function() {
  ...
  Object.defineProperty(Utility2.prototype, "amount", {
    get: function() {
  ...
  Object.defineProperty(Utility2.prototype, "body", {
    get: function() {
      return this.match(/-.+/).substring(1);
    },
    enumerable: false,
  ...
  Object.defineProperty(Utility2.prototype, "handler", {
    get: function() {
      return this._h(this);
    },
    enumerable: false,
...
function generateStaticStyle(processor, className, addComment) {
  if (addComment === void 0) {
    addComment = false;
  }
  if (!staticUtilities.hasOwnProperty(className))
    return;
  var style = new Style("." + className);
  var comment = addComment ? className : void 0;
  var _a = staticUtilities[className], utility = _a.utility, meta = _a.meta;
  var _loop_1 = function(key2, value2) {
    style.add(Array.isArray(value2) ? value2.map(function(i) {
      return new Property(key2, i, comment);
    }) : new Property(key2, value2, comment));
  };
...
function extract(processor, className, addComment, prefix) {
  ...
  for (var _i = 0, _a = Object.entries(processor._plugin.dynamic); _i < _a.length; _i++) {
    ...
    if (className.match(new RegExp("^-?".concat(key_1)))) {
      ...
      if (style && addComment)
        Array.isArray(style) ? style.map(function(i) {
          return i.property.forEach(function(p) {
            return p.comment = className;
          });
        }) : style.property.forEach(function(p) {
          return p.comment = className;
        });
      if (style)
        return style;
  ...
  var key = matches ? matches[0] : void 0;
...
function preflight(processor, html, includeBase, includeGlobal, includePlugins) {
  ...
  if (includeGlobal === void 0) {
    includeGlobal = true;
  }
  if (includePlugins === void 0) {
    includePlugins = true;
  }
  ...
  var createStyle = function(selector, properties, isGlobal) {
    ...
    var style = new Style(selector, void 0, false);
    var _loop_1 = function(key2, value2) {
      style.add(Array.isArray(value2) ? value2.map(function(v) {
        return new Property(key2, v);
      }) : new Property(key2, typeof value2 === "function" ? value2(function(path, defaultValue) {
  ...
  var tags = html ? Array.from(new Set(html.match(/<\w+/g))).map(function(i) {
    return i.substring(1);
  }) : void 0;
  includeBase && (processor.config("prefixer") ? preflights : preflights.filter(function(i) {
    return !i.selector || !/::?(webkit-input|-moz|-ms-input)-placeholder$/.test(i.selector);
  })).forEach(function(p) {
    if (includeGlobal && p.global) {
      globalSheet.add(createStyle(p.selector, p.properties, true));
    } else if (tags !== void 0) {
      var includeTags = tags.filter(function(i) {
        return p.keys.includes(i);
      });
...
function toSource(object, replacer, indent2 = "  ", startingIndent = "") {
  const seen = [];
  return walk(object, replacer, indent2 === false ? "" : indent2, startingIndent, seen);
  function walk(object2, replacer2, indent3, currentIndent, seen2) {
    const nextIndent = currentIndent + indent3;
    object2 = replacer2 ? replacer2(object2) : object2;
    switch (typeof object2) {
      case "string":
        return JSON.stringify(object2);
      case "number":
        if (Object.is(object2, -0)) {
          return "-0";
        }
    ...
    if (object2 instanceof Date) {
      return `new Date(${object2.getTime()})`;
    }
    if (object2 instanceof Set) {
      return `new Set(${walk(Array.from(object2.values()), replacer2, indent3, nextIndent, seen2)})`;
    }
    if (object2 instanceof Map) {
      return `new Map(${walk(Array.from(object2.entries()), replacer2, indent3, nextIndent, seen2)})`;
    }
    if (seen2.indexOf(object2) >= 0) {
      return "{$circularReference:1}";
    }
    seen2.push(object2);
    function join(elements) {
      return indent3.slice(1) + elements.join("," + (indent3 && "\n") + nextIndent) + (indent3 ? " " : "");
    }
    if (Array.isArray(object2)) {
      return `[${join(object2.map((element) => walk(element, replacer2, indent3, nextIndent, seen2.slice())))}]`;
    }
    const keys = Object.keys(object2);
    if (keys.length) {
      return `{${join(keys.map((key) => (legalKey(key) ? key : JSON.stringify(key)) + ":" + walk(object2[key], replacer2, indent3, nextIndent, seen2.slice())))}}`;
    }
    return "{}";
  }
}
...
var Processor = function() {
  function Processor2(config) {
    ...
    this.variantUtils = {
      ...
      atRule: function(name) {
        return new Style().atRule(name);
      },
      pseudoClass: function(name) {
        return new Style().pseudoClass(name);
      },
      pseudoElement: function(name) {
        return new Style().pseudoElement(name);
      },
      parent: function(name) {
        return new Style().parent(name);
      },
      child: function(name) {
        return new Style().child(name);
      }
    };
  ...
  Processor2.prototype._resolveConfig = function(userConfig, presets) {
    var _a;
    if (presets === void 0) {
      presets = {};
    }
    ...
    return __assign(__assign(__assign({}, presets), userConfig), { theme });
  };
  Processor2.prototype._reduceFunction = function(theme, extendTheme) {
    var _loop_1 = function(key2, value2) {
      var themeValue = theme[key2];
      switch (typeof themeValue) {
        case "function":
          theme[key2] = function(theme2, _a2) {
            var negative2 = _a2.negative, breakpoints2 = _a2.breakpoints;
            return combineConfig(themeValue(theme2, { negative: negative2, breakpoints: breakpoints2 }), typeof value2 === "function" ? value2(theme2, { negative: negative2, breakpoints: breakpoints2 }) : value2 !== null && value2 !== void 0 ? value2 : {});
          };
          break;
        case "object":
          theme[key2] = function(theme2, _a2) {
            var negative2 = _a2.negative, breakpoints2 = _a2.breakpoints;
            return combineConfig(themeValue, typeof value2 === "function" ? value2(theme2, { negative: negative2, breakpoints: breakpoints2 }) : value2 !== null && value2 !== void 0 ? value2 : {}, 0);
          };
          break;
        default:
          theme[key2] = value2;
  ...
  Processor2.prototype._resolvePresets = function(presets) {
    var _this = this;
    var config = {};
    var extend = {};
  ...
  Processor2.prototype._resolveFunction = function(config) {
    var _this = this;
    var _a;
    if (!config.theme)
      return config;
    var theme = function(path, defaultValue) {
      return _this.theme(path, defaultValue);
    };
  ...
  Processor2.prototype._replaceStyleVariants = function(styles) {
    var _this = this;
    styles.forEach(function(style) {
      ...
      style.atRules = (_a = style.atRules) === null || _a === void 0 ? void 0 : _a.map(function(i) {
        ...
        if (i.match(/@screen/)) {
          ...
          var atRule = (_a2 = _this._variants[variant]().atRules) === null || _a2 === void 0 ? void 0 : _a2[0];
  ...
  Processor2.prototype._addPluginProcessorCache = function(type, key, styles) {
    styles = toArray(styles);
    this._plugin[type][key] = key in this._plugin[type] ? __spreadArray(__spreadArray([], this._plugin[type][key], true), styles, true) : styles;
  };
  Processor2.prototype._loadVariables = function() {
  ...
  Processor2.prototype.loadConfig = function(config) {
    this._config = this.resolveConfig(config, baseConfig);
    this._theme = this._config.theme;
    this._handler = createHandler(this._config.handlers);
    this._config.shortcuts && this.loadShortcuts(this._config.shortcuts);
  ...
  Processor2.prototype.resolveConfig = function(config, presets) {
    var _this = this;
    var _a;
    this._config = this._resolveConfig(__assign(__assign({}, deepCopy(config ? config : {})), { exclude: config === null || config === void 0 ? void 0 : config.exclude }), deepCopy(presets));
    this._theme = this._config.theme;
    (_a = this._config.plugins) === null || _a === void 0 ? void 0 : _a.map(function(i) {
      return typeof i === "function" ? "__isOptionsFunction" in i ? _this.loadPluginWithOptions(i) : _this.loadPlugin(createPlugin(i)) : _this.loadPlugin(i);
    });
  ...
  Processor2.prototype.resolveVariants = function(type) {
  ...
  Processor2.prototype.resolveStaticUtilities = function(includePlugins) {
    if (includePlugins === void 0) {
  ...
  Processor2.prototype.resolveDynamicUtilities = function(includePlugins) {
    if (includePlugins === void 0) {
      includePlugins = false;
    }
    if (!includePlugins)
  ...
  Object.defineProperty(Processor2.prototype, "allConfig", {
    get: function() {
      return this._config;
    },
    enumerable: false,
  ...
  Object.defineProperty(Processor2.prototype, "allTheme", {
    get: function() {
      var _a;
  ...
  Object.defineProperty(Processor2.prototype, "allVariant", {
    get: function() {
  ...
  Processor2.prototype.wrapWithVariants = function(variants, styles) {
    var _this = this;
    ...
    return styles.map(function(style) {
      if (style instanceof Keyframes)
        return style;
      var atrules = [];
      var wrapped = variants.filter(function(i) {
        var _a;
        return (_a = _this._variants) === null || _a === void 0 ? void 0 : _a[i];
      }).map(function(i) {
        return _this._variants[i]();
  ...
  Processor2.prototype.removePrefix = function(className) {
    var prefix = this.config("prefix");
    return prefix ? className.replace(new RegExp("^".concat(prefix)), "") : className;
  };
  Processor2.prototype.markAsImportant = function(style, force) {
    if (force === void 0) {
      force = false;
    }
    ...
    if (important) {
      if (typeof important === "string") {
        ...
        style.property.forEach(function(i) {
          return i.important = true;
        });
      }
    }
  ...
  Processor2.prototype.extract = function(className, addComment, prefix) {
    if (addComment === void 0) {
      addComment = false;
    }
    return extract(this, className, addComment, prefix);
  };
  Processor2.prototype.test = function(className, prefix) {
    return test(this, className, prefix);
  };
  Processor2.prototype.preflight = function(html, includeBase, includeGlobal, includePlugins, ignoreProcessed) {
    if (includeBase === void 0) {
      includeBase = true;
    }
    if (includeGlobal === void 0) {
  ...
  Processor2.prototype.interpret = function(classNames, ignoreProcessed, handleIgnored) {
    var _this = this;
    if (ignoreProcessed === void 0) {
      ignoreProcessed = false;
    }
    ...
    var _hGroup = function(obj, parentVariants) {
      ...
      var _eval = function(u) {
        if (u.type === "group") {
          ...
          _this._plugin.alias[u.content].forEach(function(i) {
            return _eval(i);
          });
        } else {
          ...
          typeof u.content === "string" && _gStyle(u.content, variants, selector, important, _this.config("prefix"));
        }
      };
      Array.isArray(obj.content) && obj.content.forEach(function(u) {
        return _eval(u);
      });
    };
    var _gAst = function(ast2) {
      ast2.forEach(function(obj) {
  ...
  Processor2.prototype.validate = function(classNames) {
    var _this = this;
    var ast = new ClassParser(classNames, this.config("separator", ":"), this._cache.variants).parse();
    var success = [];
    var ignored = [];
    var _hSuccess = function(className, self, parent) {
      success.push(__assign(__assign({ className }, self), { parent }));
    };
    var _hIgnored = function(className, self, parent) {
      ignored.push(__assign(__assign({ className }, self), { parent }));
    };
    var _gStyle = function(baseClass, variants, selector, self, parent, prefix) {
      ...
      if (_this.test(baseClass, prefix) && variants.filter(function(i) {
        return !(i in _this._variants);
      }).length === 0) {
        _hSuccess(selector, self, parent);
      } else {
        _hIgnored(selector, self, parent);
    ...
    var _hGroup = function(obj, parentVariants) {
      ...
      var _eval = function(u, parent) {
        if (u.type === "group") {
          ...
          var important = obj.important || u.important;
          var selector = (important ? "!" : "") + __spreadArray(__spreadArray([], variants, true), [u.content], false).join(":");
          typeof u.content === "string" && _gStyle(u.content, variants, selector, u, parent, _this.config("prefix"));
        }
      };
      Array.isArray(obj.content) && obj.content.forEach(function(u) {
        return _eval(u, obj);
      ...
      ast2.forEach(function(obj) {
        if (obj.type === "utility") {
          if (Array.isArray(obj.content))
            ...
            _gStyle(obj.content, obj.variants, obj.raw, obj, void 0, _this.config("prefix"));
          }
        } else if (obj.type === "group") {
          _hGroup(obj);
        } else if (obj.type === "alias" && obj.content in _this._plugin.alias) {
  ...
  Processor2.prototype.compile = function(classNames, prefix, showComment, ignoreGenerated, handleIgnored, outputClassName) {
    var _this = this;
    if (prefix === void 0) {
      prefix = "windi-";
    }
    if (showComment === void 0) {
      showComment = false;
    }
    if (ignoreGenerated === void 0) {
    ...
    var _hIgnored = function(className2) {
      if (handleIgnored) {
        var style = handleIgnored(className2);
        if (style) {
          styleSheet.add(style);
          success.push(className2);
        } else {
          ignored.push(className2);
        }
      }
      ignored.push(className2);
    };
    ...
    var _hGroup = function(obj, parentVariants) {
      ...
      Array.isArray(obj.content) && obj.content.forEach(function(u) {
        if (u.type === "group") {
          ...
          typeof u.content === "string" && _gStyle(_this.removePrefix(u.content), variants, selector, obj.important || u.important);
        }
      });
    };
    ...
    className = success.length > 0 ? className : void 0;
  ...
  Processor2.prototype.attributify = function(attrs, ignoreProcessed) {
    var _this = this;
    if (ignoreProcessed === void 0) {
      ignoreProcessed = false;
    }
    ...
    var _gStyle = function(key2, value2, equal, notAllow, ignoreProcessed2) {
      var _a2, _b2;
      if (equal === void 0) {
        equal = false;
      }
      ...
      if (ignoreProcessed2 === void 0) {
        ignoreProcessed2 = false;
      }
      var buildSelector = "[".concat(_this.e((prefix || "") + key2)).concat(equal ? "=" : "~=", '"').concat(value2, '"]');
      if (notAllow || ignoreProcessed2 && _this._cache.attrs.includes(buildSelector)) {
        ignored.push(buildSelector);
        return;
      }
      var importantValue = value2.startsWith("!");
      if (importantValue)
        value2 = value2.slice(1);
      var importantKey = key2.startsWith("!");
      if (importantKey)
        key2 = key2.slice(1);
      var id = (_b2 = (_a2 = key2.match(/\w+$/)) === null || _a2 === void 0 ? void 0 : _a2[0]) !== null && _b2 !== void 0 ? _b2 : "";
      var splits = value2.split(separator || ":");
      var variants = splits.slice(0, -1);
      var utility = splits.slice(-1)[0];
      var keys = key2.split(separator || ":");
      ...
      if (style) {
        ...
        if (variants.find(function(i) {
          ...
          if (wrapped) {
            ignoreProcessed2 && _this._cache.attrs.push(buildSelector);
    ...
    var _loop_2 = function(key2, value2) {
      var notAllow = false;
      if (prefix) {
        if (key2.startsWith(prefix)) {
          key2 = key2.slice(prefix.length);
        } else {
          notAllow = true;
        }
      }
      if (disable === null || disable === void 0 ? void 0 : disable.includes(key2))
        notAllow = true;
      if (Array.isArray(value2)) {
        value2.forEach(function(i) {
          return _gStyle(key2, i, false, notAllow, ignoreProcessed);
        });
      } else {
        _gStyle(key2, value2, true, notAllow, ignoreProcessed);
      }
    };
  ...
  Processor2.prototype.loadPlugin = function(_a) {
  ...
  Processor2.prototype.loadPluginWithOptions = function(optionsFunction, userOptions) {
    var plugin = optionsFunction(userOptions !== null && userOptions !== void 0 ? userOptions : {});
    this.loadPlugin(plugin);
  };
  Processor2.prototype.loadShortcuts = function(shortcuts) {
    var _this = this;
    var _loop_3 = function(key2, value2) {
      var prefix = this_1.config("prefix", "");
      if (typeof value2 === "string") {
        this_1._plugin.shortcuts[key2] = this_1.compile(value2, void 0, void 0, false, void 0, cssEscape(prefix + key2)).styleSheet.children.map(function(i) {
          return i.updateMeta("components", "shortcuts", layerOrder["shortcuts"], ++_this._cache.count);
        });
      } else {
        var styles_1 = [];
        Style.generate("." + cssEscape(key2), value2).forEach(function(style) {
          for (var _i2 = 0, _a2 = style.property; _i2 < _a2.length; _i2++) {
            var prop = _a2[_i2];
            if (!prop.value)
              continue;
            if (prop.name === "@apply") {
              styles_1 = styles_1.concat(_this.compile(Array.isArray(prop.value) ? prop.value.join(" ") : prop.value).styleSheet.children.map(function(i) {
                var newStyle2 = deepCopy(style);
                newStyle2.property = [];
                return newStyle2.extend(i);
              }));
            } else {
        ...
        this_1._plugin.shortcuts[key2] = styles_1.map(function(i) {
          return i.updateMeta("components", "shortcuts", layerOrder["shortcuts"], ++_this._cache.count);
        });
      }
    };
  ...
  Processor2.prototype.loadAlias = function(alias) {
    for (var _i = 0, _a = Object.entries(alias); _i < _a.length; _i++) {
      var _b = _a[_i], key = _b[0], value = _b[1];
      this._plugin.alias[key] = new ClassParser(value, void 0, this._cache.variants).parse();
    }
  };
  Processor2.prototype.config = function(path, defaultValue) {
    var _this = this;
    var _a;
    if (path === "corePlugins")
      return this._plugin.core ? Object.keys(this._plugin.core).filter(function(i) {
        var _a2;
        return (_a2 = _this._plugin.core) === null || _a2 === void 0 ? void 0 : _a2[i];
  ...
  Processor2.prototype.theme = function(path, defaultValue) {
    var _a;
    return this._theme ? (_a = getNestedValue(this._theme, path)) !== null && _a !== void 0 ? _a : defaultValue : void 0;
  };
  Processor2.prototype.corePlugins = function(path) {
    var _a;
  ...
  Processor2.prototype.variants = function(path, defaultValue) {
  ...
  Processor2.prototype.e = function(selector) {
    return cssEscape(selector);
  };
  Processor2.prototype.prefix = function(selector) {
    var _a;
    return selector.replace(/(?=[\w])/, (_a = this._config.prefix) !== null && _a !== void 0 ? _a : "");
  };
  Processor2.prototype.addUtilities = function(utilities, options) {
    var _this = this;
    var _a;
    if (options === void 0) {
      options = {
    ...
    if (Array.isArray(utilities))
      utilities = utilities.reduce(function(previous, current) {
        return combineConfig(previous, current);
      }, {});
    var output = [];
    var layer = (_a = options.layer) !== null && _a !== void 0 ? _a : "utilities";
    var order2 = layerOrder[layer] + 1;
    var _loop_4 = function(key2, value2) {
      var propertyValue = value2;
      if (Array.isArray(value2)) {
        propertyValue = Object.assign.apply(Object, __spreadArray([{}], value2, false));
      }
      var styles = Style.generate(key2.startsWith(".") && options.respectPrefix ? this_2.prefix(key2) : key2, propertyValue);
      if (options.layer)
        styles.forEach(function(style) {
          return style.updateMeta(layer, "plugin", order2, ++_this._cache.count);
        });
      if (options.respectImportant && this_2._config.important)
        styles.forEach(function(style) {
          return style.important = true;
        });
      var className = guessClassName(key2);
      if (key2.charAt(0) === "@") {
        styles.forEach(function(style) {
          if (style.selector)
          ...
          if (Array.isArray(className)) {
            className.filter(function(i) {
              ...
              var selector = _a2.selector, pseudo = _a2.pseudo;
              return _this._addPluginProcessorCache("utilities", selector, pseudo ? style.clone("." + cssEscape(selector)).wrapSelector(function(selector2) {
                return selector2 + pseudo;
              }) : style.clone());
            });
            var base = className.filter(function(i) {
              return !i.isClass;
            }).map(function(i) {
              return i.selector;
            }).join(", ");
            ...
            _this._addPluginProcessorCache(className.isClass ? "utilities" : "static", className.selector, className.pseudo ? style.clone("." + cssEscape(className.selector)).wrapSelector(function(selector) {
              return selector + className.pseudo;
            }) : style.clone());
          }
        });
        ...
        className.filter(function(i) {
          ...
          var selector = _a2.selector, pseudo = _a2.pseudo;
          return _this._addPluginProcessorCache("utilities", selector, pseudo ? styles.map(function(i) {
            return i.clone("." + cssEscape(selector)).wrapSelector(function(selector2) {
              return selector2 + pseudo;
            });
          }) : deepCopy(styles));
        });
        var base_1 = className.filter(function(i) {
          return !i.isClass;
        }).map(function(i) {
          return i.selector;
        }).join(", ");
        if (base_1)
          this_2._addPluginProcessorCache("static", base_1, styles.map(function(i) {
            return i.clone(base_1);
          }));
      } else {
        this_2._addPluginProcessorCache(className.isClass ? "utilities" : "static", className.selector, className.pseudo ? styles.map(function(style) {
          return style.clone("." + cssEscape(className.selector)).wrapSelector(function(selector) {
            return selector + className.pseudo;
          });
        }) : styles);
      }
  ...
  Processor2.prototype.addDynamic = function(key, generator, options) {
    var _this = this;
    if (options === void 0) {
      options = {
        layer: "utilities",
    ...
    var order2 = uOptions.order || layerOrder[layer] + 1;
    ...
    var style = function(selector, property, important) {
      if (important === void 0) {
        important = uOptions.respectImportant && _this._config.important ? true : false;
      }
    ...
    var keyframes2 = function(selector, property, important) {
      if (important === void 0) {
        important = uOptions.respectImportant && _this._config.important ? true : false;
      }
      return new Keyframes(selector, property, important);
    };
    keyframes2.generate = Keyframes.generate;
    style.generate = Style.generate;
    prop.parse = Property.parse;
    this._plugin.dynamic[key] = key in this._plugin.dynamic ? function(Utility2) {
      return deepCopy(_this._plugin.dynamic[key])(Utility2) || generator({ Utility: Utility2, Style: style, Property: prop, Keyframes: keyframes2 });
    } : function(Utility2) {
      var output = generator({ Utility: Utility2, Style: style, Property: prop, Keyframes: keyframes2 });
      if (!output)
        return;
      if (Array.isArray(output))
        return output.map(function(i) {
          return i.updateMeta(layer, group, order2, ++_this._cache.count, false, i.meta.respectSelector || uOptions.respectSelector);
        });
      return output.updateMeta(layer, group, order2, ++_this._cache.count, false, output.meta.respectSelector || uOptions.respectSelector);
    };
    return generator;
  };
  Processor2.prototype.addComponents = function(components, options) {
    var _this = this;
    var _a;
    if (options === void 0) {
    ...
    if (Array.isArray(components))
      components = components.reduce(function(previous, current) {
        return combineConfig(previous, current);
      }, {});
    var output = [];
    var layer = (_a = options.layer) !== null && _a !== void 0 ? _a : "components";
    var order2 = layerOrder[layer] + 1;
    var _loop_5 = function(key2, value2) {
      var propertyValue = value2;
      if (Array.isArray(value2)) {
        propertyValue = Object.assign.apply(Object, __spreadArray([{}], value2, false));
      }
      var styles = Style.generate(key2.startsWith(".") && options.respectPrefix ? this_3.prefix(key2) : key2, propertyValue);
      styles.forEach(function(style) {
        return style.updateMeta(layer, "plugin", order2, ++_this._cache.count);
      });
      ...
      if (key2.charAt(0) === "@") {
        styles.forEach(function(style) {
          ...
          if (Array.isArray(className)) {
            className.filter(function(i) {
              ...
              var selector = _a2.selector, pseudo = _a2.pseudo;
              return _this._addPluginProcessorCache("components", selector, pseudo ? style.clone("." + cssEscape(selector)).wrapSelector(function(selector2) {
                return selector2 + pseudo;
              }) : style.clone());
            });
            var base = className.filter(function(i) {
            ...
            _this._addPluginProcessorCache(className.isClass ? "components" : "static", className.selector, className.pseudo ? style.clone("." + cssEscape(className.selector)).wrapSelector(function(selector) {
              return selector + className.pseudo;
            }) : style.clone());
          }
        });
      } else if (Array.isArray(className)) {
        if (className.some(function(i) {
          return !i.isClass;
        })) {
          var base_2 = className.map(function(i) {
            return i.selector;
          }).join(", ");
          if (base_2)
            this_3._addPluginProcessorCache("static", base_2, styles.map(function(i) {
              return i.clone(base_2);
            }));
        } else {
          className.forEach(function(_a2) {
            var selector = _a2.selector, pseudo = _a2.pseudo;
            return _this._addPluginProcessorCache("components", selector, pseudo ? styles.map(function(i) {
              return i.clone("." + cssEscape(selector)).wrapSelector(function(selector2) {
                return selector2 + pseudo;
              });
            }) : deepCopy(styles));
        ...
        this_3._addPluginProcessorCache(className.isClass ? "components" : "static", className.selector, className.pseudo ? styles.map(function(style) {
          return style.clone("." + cssEscape(className.selector)).wrapSelector(function(selector) {
            return selector + className.pseudo;
          });
        }) : styles);
  ...
  Processor2.prototype.addBase = function(baseStyles) {
    var _this = this;
    var output = [];
    for (var _i = 0, _a = Object.entries(baseStyles); _i < _a.length; _i++) {
      ...
      var styles = Style.generate(key, propertyValue).map(function(i) {
        return i.updateMeta("base", "plugin", 10, ++_this._cache.count);
      });
...
// dep:windicss
var windicss_default = Processor;
export {
  windicss_default as default
};
/*! *****************************************************************************
